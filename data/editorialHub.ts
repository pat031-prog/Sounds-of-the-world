...
const argentinaCanon: HubChartEntry[] = [
  ...
  { rank: 14, chart: 'Cult Canon // AR', artist: 'El Otro Yo', albumName: 'Abrecaminos', year: '1999', label: 'Besótico', blurb: 'Indie punk explosivo, voces duales y espíritu de sello independiente hecho a pulmón.', whyItMatters: 'La consagración definitiva del rock independiente juvenil en Argentina.', coverImageUrl: appleArt('https://is1-ssl.mzstatic.com/image/thumb/Music211/v4/19/70/5f/19705f30-962d-183c-4ba9-076ba347be63/8721215902485.png/100x100bb.jpg'), coverSourceUrl: 'https://music.apple.com/us/album/abrecaminos/1828434557?uo=4', source: 'Canon AR Sónico', sourceUrl: PITCHFORK_BEST_2025_URL, territory: 'Argentina' },
];
