...
const _newSignalData: HubChartEntry[] = [
  ...
  { rank: 25, chart: 'New Signal', artist: 'Zizzy', albumName: 'SE SIENTE BIEN', year: '2025', label: 'Warner Music México', blurb: 'Urbano latino mutante: beats líquidos y actitud callejera con producción de futuro.', whyItMatters: 'Trae una energía fresca al cruce entre urbano, electrónica y canción desde el Río de la Plata.', coverImageUrl: appleArt('https://is1-ssl.mzstatic.com/image/thumb/Music211/v4/e4/e8/e7/e4e8e7c4-e3ac-5798-d171-cc7055c472f4/5021732836571.jpg/100x100bb.jpg'), coverSourceUrl: 'https://music.youtube.com/playlist?list=OLAK5uy_naIsRkqYUVw7DBDidbJf6HZ-P-7S1g5M0', source: 'Editorial Pick', sourceUrl: PITCHFORK_BEST_2025_URL, territory: 'Argentina', trend: 'new' },
...
export const playlistBundles: EditorialPlaylistBundle[] = [
  ...
  },
  {
    ...
    highlights: [
      { artist: 'Goldie', title: 'Timeless', note: 'El disco que convirtió al jungle en sinfonía urbana y lo sacó del underground para siempre.', source: 'CCRU / k-punk', sourceUrl: 'https://k-punk.abstractdynamics.org/', youtubeQuery: 'Goldie Timeless full album' },
      { artist: 'Photek', title: 'Modus Operandi', note: 'Techstep quirúrgico: la precisión rítmica que Fisher asociaba con el futurismo real del jungle.', source: 'CCRU / k-punk', sourceUrl: 'https://k-punk.abstractdynamics.org/', youtubeQuery: 'Photek Modus Operandi' },
      { artist: 'Roni Size & Reprazent', title: 'New Forms', note: 'Bristol bass meets jazz sampling: el Mercury Prize que legitimó al d&b.', source: 'CCRU / k-punk', sourceUrl: 'https://k-punk.abstractdynamics.org/', youtubeQuery: 'Roni Size New Forms' },
      { artist: 'Mark Fisher', title: 'Ghosts of My Life (lectura)', note: 'El texto clave sobre hauntología: los futuros perdidos que el jungle prometía y que nunca llegaron.', source: 'k-punk / Repeater Books', sourceUrl: 'https://repeaterbooks.com/product/ghosts-of-my-life/', youtubeQuery: 'Mark Fisher Ghosts of My Life lecture' },
      { artist: 'CCRU', title: 'Writings 1997-2003', note: 'Aceleracionismo, hiperstición y la teoría que conectó jungle con filosofía continental.', source: 'Urbanomic', sourceUrl: 'https://www.urbanomic.com/book/ccru-writings-1997-2003/', youtubeQuery: 'CCRU cybernetic culture research unit' },
    ],
  },
];
